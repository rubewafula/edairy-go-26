...
type CreateMemberRequest struct {
	...
	IDFrontPhoto  string `json:"id_front_photo" validate:"required,max=255"`
	IDBackPhoto   string `json:"id_back_photo" validate:"required,max=255"`
	PassportPhoto string `json:"passport_photo" validate:"required,max=255"`
